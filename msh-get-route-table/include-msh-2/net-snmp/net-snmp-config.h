...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp' '--disable-mib-loading' '--disable-debugging' '--disable-agent' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--without-openssl' '--with-transports=UDP' '--without-kmem-usage' '--without-perl-modules' '--disable-embedded-perl' '--with-persistent-directory=var/msh-snmp' '--with-logfile=var/log/mshsnmp.log' '--with-pic' '--with-out-transports=AAL5PVC IPX DTLSUDP TLSTCP SSH' '--with-default-snmp-version=2' '--with-sys-contact=@@msh.where' '--with-sys-location=Unknown'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp/share/snmp/mibs"
...
#define NETSNMP_PERSISTENT_DIRECTORY "var/msh-snmp"
...
#define SNMPLIBPATH "/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp/lib/snmp"
#define SNMPSHAREPATH "/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp/share/snmp"
#define SNMPCONFPATH "/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp/etc/snmp"
#define SNMPDLMODPATH "/home/msh/Desktop/snmp-learn/net-snmp-learn/svn-snmp/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "var/log/mshsnmp.log"

/* default system contact */
#define NETSNMP_SYS_CONTACT "@@msh.where"
