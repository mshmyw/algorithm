...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/home/snmp' '--disable-option-checking' '--disable-FEATURE' '--disable-mib-loading' '--disable-debugging' '--disable-agent' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--disable-deprecated' '--without-openssl' '--with-transports=UDP' '--without-kmem-usage' '--without-perl-modules' '--disable-embedded-perl' '--with-persistent-directory=var/msh-snmp' '--with-logfile=var/log/mshsnmp.log' '--with-pic' '--with-out-transports=AAL5PVC IPX DTLSUDP TLSTCP SSH' '--with-default-snmp-version=2' '--with-sys-contact=@@root.msh' '--with-sys-location=msh'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/snmp/share/snmp/mibs"
...
#define SNMPLIBPATH "/home/snmp/lib/snmp"
#define SNMPSHAREPATH "/home/snmp/share/snmp"
#define SNMPCONFPATH "/home/snmp/etc/snmp"
#define SNMPDLMODPATH "/home/snmp/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "@@root.msh"

/* system location */
#define NETSNMP_SYS_LOC "msh"
